sap.ui.define([
	...
	return Opa5.extend("ey.manageproducts.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["ey/manageproducts/localService/mockserver"], function (mockserver) {
